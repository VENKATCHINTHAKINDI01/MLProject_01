...
# -----------------------------
DATA_INGESTION_COLLECTION_NAME: str = "NetworkData"   # FIXED (removed space)
...
MODEL_TRAINER_EXPECTED_SCORE: float = 0.6 #atleast expected score for better model score
